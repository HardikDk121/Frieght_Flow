...
class _LiveMapWidgetState extends State<LiveMapWidget> {
  ...
  LatLng? get _truckPos => widget.trip.currentLocation != null
      ? LatLng(widget.trip.currentLocation!.latitude,
          widget.trip.currentLocation!.longitude)
      : null;
  ...
  Set<Marker> _markers() {
    ...
    if (_originCoord != null) {
      m.add(Marker(
          ...
          position: _originCoord!,
          infoWindow: InfoWindow(title: widget.route.origin, snippet: 'Origin'),
    ...
    if (_destCoord != null) {
      m.add(Marker(
          ...
          infoWindow: InfoWindow(
              title: widget.route.destination, snippet: 'Destination'),
          icon: BitmapDescriptor.defaultMarkerWithHue(
  ...
  Set<Polyline> _polylines() {
    ...
    return {
      Polyline(
          ...
          points: [_originCoord!, _destCoord!],
  ...
  CameraPosition _camera() {
    if (_originCoord != null && _destCoord != null) {
      return CameraPosition(
          target: LatLng((_originCoord!.latitude + _destCoord!.latitude) / 2,
